...
/**
 *
 * @author Edivan www.vegasconsultoria.com.br
 */
public class ViewiPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Vegas - VegaSYS: www.vegasconsultoria.com.br");
        ...
        jbRelatorioVendas.setEnabled(false);
        ...
        jmiFluxoCaixa.setEnabled(false);
        ...
        jmiRelatorioContas.setEnabled(false);
    ...
    private void jmiSobreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jmiSobreActionPerformed
        JOptionPane.showMessageDialog(null, "versão de demonstração");
    ...
    private void liberarModulos() {
        ...
        for (int i = 0; i < listaModelPermissaousuarios.size(); i++) {
            ...
            if (listaModelPermissaousuarios.get(i).getPermissao().equals("caixa")) {
                ...
                jmiFluxoCaixa.setEnabled(true);
                jmiRelatorioContas.setEnabled(true);
            }
        }
    }
