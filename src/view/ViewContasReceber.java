...
public class ViewContasReceber extends javax.swing.JFrame {
    ...
    private boolean recuperarConta(int pCodigoConta) {
        ...
        this.jcbClientes.setSelectedItem(controllerCliente.getClienteController(modelContaReceber.getCodigoPessoa()).getNome());
        ...
        this.jcbTipoPagamento.setSelectedItem(controllerTipoPagamento.getTipoPagamentoController(modelContaReceber.getTipoPagamento()).getDescricao());
        return true;
    }
    ...
    private boolean salvar() {
        BLDatas bl = new BLDatas();
        modelContaReceber.setCodigoPessoa(controllerCliente.getClienteController(this.jcbClientes.getSelectedItem().toString()).getCodigo());
        ...
        modelContaReceber.setTipoPagamento(controllerTipoPagamento.getTipoPagamentoController(this.jcbTipoPagamento.getSelectedItem().toString()).getCodigo());
