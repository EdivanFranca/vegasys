...
public class ViewVenda extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(tfQuantidade, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 80, 60, -1));
    ...
    private boolean cadastrarVenda() {
        if (tfDesconto.getText().equals("") || tfValorTotal.getText().equals("") || tbProdutos.getRowCount() < 1) {
            ...
            for (int i = 0; i < tbProdutos.getRowCount(); i++) {
                ...
                quantidade = controllerProdutos.getProdutosController(codigoProduto).getEstoque() - Float.parseFloat(tbProdutos.getValueAt(i, 2).toString());
