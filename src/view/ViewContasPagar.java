...
public class ViewContasPagar extends javax.swing.JFrame {
    ...
    private boolean recuperarConta(int pCodigoConta) {
        ...
        this.jcbClientes.setSelectedItem(controllerFornecedor.getFornecedorController(modelContaPagar.getCodigoPessoa()).getNome());
    ...
    private boolean salvar() {
        ...
        modelContaPagar.setCodigoPessoa(controllerFornecedor.getFornecedorController(this.jcbClientes.getSelectedItem().toString()).getCodigo());
