...
public class ViewFluxoCaixa extends javax.swing.JFrame {
    ...
    private void carregarContas() {
        ...
        for (int i = 0; i < contPagar; i++) {
            ...
            tipoPagamento = controllerTipoPagamento.getTipoPagamentoController(listaModelContasPagar.get(i).getTipoPagamento()).getDescricao();
        ...
        for (int i = 0; i < contReceber; i++) {
            ...
            tipoPagamento = controllerTipoPagamento.getTipoPagamentoController(listaModelContasReceber.get(i).getTipoPagamento()).getDescricao();
            modelo.addRow(new Object[]{
