...
public class ViewUsuario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jcbPDV = new javax.swing.JCheckBox();
        ...
        jcbFluxoCaixa = new javax.swing.JCheckBox();
        ...
        jpCadastro.add(jbConfirmarAlteracao, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 320, -1, -1));
        ...
        jpCadastro.add(jbCadastrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 320, -1, -1));
        ...
        jpCadastro.add(jbCancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 320, -1, -1));
        ...
        jpCadastro.add(jbNovo, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 320, -1, 30));
        ...
        jcbPDV.setText("Venda PDV");
        jPanel1.add(jcbPDV, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 90, -1, -1));

        jcbFornecedores.setText("Fornecedor");
        jPanel1.add(jcbFornecedores, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 90, -1, -1));

        jcbUsuario.setText("Usuário");
        jPanel1.add(jcbUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 30, -1, -1));

        jcbVendas.setText("Venda por cliente");
        ...
        jcbFluxoCaixa.setText("Fluxo de caixa");
        jPanel1.add(jcbFluxoCaixa, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 90, -1, -1));

        jpCadastro.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 170, 490, 140));

        jLabel6.setText("Grupo:");
        jpCadastro.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 130, -1, -1));
        ...
        jpCadastro.add(jTGrupo, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 130, 40, -1));

        jLabel7.setText("1 - Usuario");
        jpCadastro.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 130, -1, -1));

        jLabel8.setText("2 - Gerente");
        jpCadastro.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 130, -1, -1));

        jLabel9.setText("3 - Caixa");
        jpCadastro.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 130, -1, -1));

        jLabel10.setText("4 - Financeiro");
        jpCadastro.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 130, -1, -1));
        ...
        getContentPane().add(jTabbedPaneTipoProduto, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 560, 400));
    ...
    private boolean salvarUsuario() {
        ...
        modelUsuario.setGrupo(Integer.parseInt(this.jTGrupo.getText()));
    ...
    public ModelPermissaousuario setardadosPermissaoUsuario(int pCodigoUsuario) {
        ...
        if (jcbPDV.isSelected()) {
            modelPermissaousuario = new ModelPermissaousuario();
            modelPermissaousuario.setCodigo_usuario(pCodigoUsuario);
            modelPermissaousuario.setPermissao("pdv");
            listaModelPermissaousuarios.add(modelPermissaousuario);
        }
    ...
    private boolean recuperarUsuario() {
        ...
        try {
            ...
            this.jTGrupo.setText(String.valueOf(modelUsuario.getGrupo()));
            ...
            for (int i = 0; i < listaModelPermissaousuarios.size(); i++) {
                ...
                if (listaModelPermissaousuarios.get(i).getPermissao().equals("pdv")) {
                ...
                if (listaModelPermissaousuarios.get(i).getPermissao().equals("caixa")) {
                    jcbFluxoCaixa.setSelected(true);
                }
    ...
    private javax.swing.JCheckBox jcbFluxoCaixa;
    private javax.swing.JCheckBox jcbFornecedores;
    private javax.swing.JCheckBox jcbPDV;
